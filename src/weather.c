...
void gameweather_init() {
    _weather.airspeed = floor(random_number(100, 800) / 100);     //Pick a random number between 0 to 5 but an scaling up and down is used to make the distribution even
